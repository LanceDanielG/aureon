...
export default function Home() {
    ...
    return (
        <div className={`relative w-[850px] min-h-[550px] bg-white shadow-2xl rounded-2xl overflow-hidden font-poppins`}> 
            <LogIn isLogin={isLogin}/>
            <Register isLogin={isLogin}/>
            <div className={`toggle-box absolute w-full h-full justify-center items-center text-white before:content-[''] before:absolute before:left-[-250%] before:w-[300%] before:h-full before:bg-blue-400 before:rounded-[150px] before:z-20 before:transition-all before:duration-[1.8s] before:ease-in-out ${!isLogin ? 'before:left-[50%]' : ''}`}>
